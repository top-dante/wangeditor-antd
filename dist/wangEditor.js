...
DropList.prototype = {
    ...
    show: function show() {
        ...
        if (this._rendered) {
            ...
            let menuHeight = $menuELem.getSizeData().height || 0;
            let width = this.opt.width || 100; // 默认为 100
...
function List(editor) {
    ...
    this.droplist = new DropList(this, {
        ...
        $title: $('<p>设置列表</p>'),
        type: 'list', // droplist 以列表形式展示
        list: [{ $elem: $('<span><i class="icon-orderedlist"></i> 有序列表</span>'), value: 'insertOrderedList' }, { $elem: $('<span><i class="icon-unorderedlist"></i> 无序列表</span>'), value: 'insertUnorderedList' }],
        onClick: function onClick(value) {
...
function ForeColor(editor) {
    ...
    this.droplist = new DropList(this, {
        ...
        list: colors.map(function (color) {
            if(color ==='#ffffff'){
                return { $elem: $('<span style="background-color:' + color + ';border:1px solid #e8e8e8" class="color-block"></span>'), value: color };
            }else {
                return { $elem: $('<span style="background-color:' + color + ';" class="color-block"></span>'), value: color };
            }
        }),
        onClick: function onClick(value) {
